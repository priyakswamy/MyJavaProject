...
public void framehandling() {
	...
	WebElement webel = driver.findElement(By.xpath("//div[@class = 'w3-dark-grey w3-center w3-padding-large w3-padding-48']"));
	//webel.click();
	int linkcount = webel.findElements(By.tagName("a")).size();
